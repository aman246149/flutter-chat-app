...
class _ChatPageState extends State<ChatPage>
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () {
        if (chatLogic.isDownloadingFile.value) {
          showSnackbar(context,
              "Please wait while the file is downloading else you will lose this file");
          chatLogic.isDownloadingFile.value = false;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ValueListenableBuilder(
                                        valueListenable:
                                            chatLogic.isDownloadingFile,
                                        builder: (context, value, child) {
                                          return Column(
                                            children: [
                                              if (value) ...[
                                                Lottie.asset(
                                                    'assets/images/downloadlocal.json',
                                                    height: 100,
                                                    width: 100,
                                                    fit: BoxFit.cover,
